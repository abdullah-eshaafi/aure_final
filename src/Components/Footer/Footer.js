    ...
    <div className="footer_main_wrapper">
      <Container fluid>
        <Container>
              ...
              <div className="col-xl-4 col-12 d-flex justify-content-xl-end justify-content-md-start justify-content-center">
                <div className="footer_img   col-xl-11">
                  <a
                    ...
                    target="_blank"
                    className="  d-flex justify-content-xl-end justify-content-start"
                  >
                    <img
          ...
          <Row className="second-footer-wrapper">
            <Col xl={6} md={12} className="px-0">
            ...
            <Container>
              ...
              <Row>
                <Col>
                  ...
                  <div className="collection_of_data">
                    <h4 className="user-select">Why do we collect data?</h4>
                  </div>
                  <div className="privacy_modal_text">
                    <p className="user-select">
                  ...
                  <div className="collection_of_data">
                    <h4 className="user-select">Data Disclosure:</h4>
                  </div>
                  ...
                  <div className="collection_of_data">
                    <h4 className="user-select">Policy about Children:</h4>
                  </div>
                  <div className="privacy_modal_text">
                    <p className="user-select">
                  ...
                  <div className="collection_of_data">
                    <h4 className="user-select">Change in Policy:</h4>
                  </div>
                  <div className="privacy_modal_text">
                    <p className="user-select">
                  ...
                  <div className="collection_of_data">
                    <h4 className="user-select">Queries: </h4>
                  </div>
                  <div className="privacy_modal_text">
                    <p className="user-select">
